export const LoanTable = ({ data, onViewDetails, onRegisterReturn, loading }) => {
    ...
    return (
      <div className="loan-table-container">
        <div className="loan-table-loading">
          ...
          <p className="loan-loading-text">Cargando prestamos...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="loan-table-container">
        <div className="loan-table-empty">
          ...
          <p className="loan-empty-text">No se encontraron prestamos</p>
        </div>
      </div>
    );
  }
                ...
                <tr key={loan.id} className={getRowClass(loan.debt_type)}>
                  <td>
                    <div className="loan-table-product">
                      <div className="loan-table-product-name">{loan.product_name || '-'}</div>
                      <div className="loan-table-product-code">{loan.product_code || '-'}</div>
                    </div>
                  </td>
                  <td>
                    <span className="loan-table-debtor">{loan.debtor_name || '-'}</span>
                  </td>
                  <td>
