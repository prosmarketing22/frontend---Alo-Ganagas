export const CustomerLoanSummaryCards = ({ summary, loading }) => {
  if (loading) {
    return (
      ...
      <div className="loan-summary-grid">
        <div className="loan-summary-card loan-summary-card--nos-deben">
          ...
          <div className="loan-summary-card__content">
            <h3 className="loan-summary-card__title">Clientes Nos Deben</h3>
            <p className="loan-summary-card__subtitle">Envases prestados a clientes</p>
        ...
        <div className="loan-summary-card loan-summary-card--debemos">
          ...
          <div className="loan-summary-card__content">
            <h3 className="loan-summary-card__title">Debemos a Clientes</h3>
            <p className="loan-summary-card__subtitle">Envases que clientes nos prestan</p>
            <div className="loan-summary-card__stats">
              <div className="loan-summary-stat">
                <span className="loan-summary-stat__label">Prestamos</span>
