...
export const SupplierLoanTable = ({ data, onViewDetails, onRegisterReturn, loading }) => {
    ...
    return (
      <div className="loan-table-container">
        <div className="loan-table-loading">
          ...
          <p className="loan-loading-text">Cargando prestamos de proveedores...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="loan-table-container">
        <div className="loan-table-empty">
          ...
          <p className="loan-empty-text">No se encontraron prestamos de proveedores</p>
        </div>
      </div>
    );
  }
            ...
            {data.map(loan => {
              ...
              return (
                <tr key={loan.id} className={getRowClass(loan.debt_type)}>
                  ...
                  <td>
                    <span className="loan-table-debtor">{loan.supplier_name || '-'}</span>
                  </td>
                  <td>
